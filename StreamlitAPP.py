...
from langchain_community.callbacks.manager import get_openai_callback#import PyPDF2


with open(r"/Users/krishgautam/mcqgen/mcq-project/Response.json", 'r') as file:
